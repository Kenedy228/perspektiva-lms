...
# Задача 2 — Удалить versionID из Progress

## Цель

Полностью отвязать Progress от version-flow.
...
- Нельзя использовать uuid.Nil
- Progress работает по elementID
- Progress не знает структуру Course
...
- Progress больше не зависит от versionID
- Все tests проходят
