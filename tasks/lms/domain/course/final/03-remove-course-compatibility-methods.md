...
# Задача 3 — Удалить compatibility methods из Course

## Цель

Полностью убрать остатки старого version-flow из Course aggregate.
...
И заменить на block-based flow.
...
- Course не содержит Version* methods
- Active code не использует version-flow
