...
# Задача 7 — Обновить HTTP routes и transport

## Цель

Убрать version-flow из HTTP API.
...
- Не добавлять frontend logic
- Не добавлять viewer logic

## Критерии готовности

- HTTP routes больше не используют versionID
